...
var bonuses = [
    ...
    {word: 'substandard', response: 'Oh Grover...'}
];
...
client.on('messageCreate', async message => {
    if (foodwords.some(word => message.toString().toLowerCase().includes(word))) {
        ...
        console.log(server);
        var usable_responses = responses.slice(0);
